...
[**Find PI to the Nth Digit**](https://github.com/corbino91/Projects/blob/master/Numbers/pi.c) – Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[**Fibonacci Sequence**](https://github.com/corbino91/Projects/blob/master/Numbers/fib.c) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
[**Reverse a String**](https://github.com/corbino91/Projects/blob/master/Text/reverse.c) – Enter a string and the program will reverse it and print it out.

[**Pig Latin**](https://github.com/corbino91/Projects/blob/master/Text/piglatin.c) – Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](https://github.com/corbino91/Projects/blob/master/Text/count_vowels.c) – Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/corbino91/Projects/blob/master/Text/palindrome.c) – Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

[**Count Words in a String**](https://github.com/corbino91/Projects/blob/master/Text/count_words.c) – Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
...
[**Product Inventory Project**](https://github.com/corbino91/Projects/blob/master/Classes/Inventory.cpp) – Create an application which manages an inventory of products. Create a product class which has a price, id, and quantity on hand. Then create an inventory class which keeps track of various products and can sum up the inventory value.
